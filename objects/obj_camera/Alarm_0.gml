/// @description reactivate the objects inside the view
/*
...
instance_deactivate_region(vx - offset , vy - offset , vw + offset, vh + offset, false,true);  //Deactivate all the instance (not us)
